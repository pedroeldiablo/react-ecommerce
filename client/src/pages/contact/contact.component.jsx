...
const ContactPage = () => {
    ...
    <div className="contact-page">
        ...
        <SimpleSlider />  
        <p>Taking the ecommerce project from course <a href="https://www.udemy.com/course/complete-react-developer-zero-to-mastery/">Complete React Developer Zero to Mastery/</a> as a starting point this project explores some of the structured approaches to buildiing a complex app with react.</p>
